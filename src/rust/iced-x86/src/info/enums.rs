...
#[cfg(feature = "instr_info")]
#[rustfmt::skip]
const GEN_DEBUG_OP_INFO0: [&str; 13] = [
	"None",
	"CondWrite",
	"CondWrite32_ReadWrite64",
	"NoMemAccess",
...
#[cfg(feature = "instr_info")]
#[rustfmt::skip]
const GEN_DEBUG_OP_INFO1: [&str; 7] = [
	"None",
	"CondRead",
	"NoMemAccess",
	"Read",
...
#[cfg(feature = "instr_info")]
#[rustfmt::skip]
const GEN_DEBUG_OP_INFO2: [&str; 3] = [
	"None",
	"Read",
	"ReadWrite",
];
...
#[cfg(feature = "instr_info")]
#[rustfmt::skip]
const GEN_DEBUG_OP_INFO3: [&str; 2] = [
	"None",
	"Read",
];
#[cfg(feature = "instr_info")]
...
#[cfg(feature = "instr_info")]
#[rustfmt::skip]
const GEN_DEBUG_OP_INFO4: [&str; 2] = [
	"None",
	"Read",
];
#[cfg(feature = "instr_info")]
...
#[cfg(feature = "instr_info")]
#[rustfmt::skip]
const GEN_DEBUG_IMPLIED_ACCESS: [&str; 201] = [
	"None",
	"Shift_Ib_MASK1FMOD9",
	"Shift_Ib_MASK1FMOD11",
	"Shift_Ib_MASK1F",
...
#[cfg(feature = "instr_info")]
#[rustfmt::skip]
const GEN_DEBUG_RFLAGS_INFO: [&str; 79] = [
	"None",
	"C_0123",
	"C_1_U_023",
	"C_A",
...
#[cfg(feature = "instr_info")]
#[rustfmt::skip]
const GEN_DEBUG_CPUID_FEATURE_INTERNAL: [&str; 199] = [
	"INTEL8086",
	"INTEL8086_ONLY",
	"INTEL186",
	"INTEL286",
